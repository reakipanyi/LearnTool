...
namespace LearningAssistant.Forms.UserControls
{
    public class ContentFieldRow : Panel
    {
        ...
        private void InitControls()
        {
            ...
            _layout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 80F));
            _layout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
            _layout.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 80F));

            _labelLabel.Font = new Font("微软雅黑", 14F, FontStyle.Bold, GraphicsUnit.Point, 134);
            ...
            _labelLabel.Padding = new Padding(0, 0, 8, 0);

            _valueLabel.Font = new Font("微软雅黑", 14F, FontStyle.Regular, GraphicsUnit.Point, 134);
            ...
            _speakButton.Text = "🔊";
            _speakButton.Font = new Font("Arial", 14F, FontStyle.Regular, GraphicsUnit.Point, 0);
            _speakButton.Width = 36;
            _speakButton.Height = 36;
            ...
            _copyButton.Text = "📋";
            _copyButton.Font = new Font("Arial", 14F, FontStyle.Regular, GraphicsUnit.Point, 0);
            _copyButton.Width = 36;
            _copyButton.Height = 36;
            ...
            _copyButton.Location = new Point(40, 0);
